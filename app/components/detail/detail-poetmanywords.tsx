...
export default function DetailPoetManyWords({ poet, onBack }: PoetDetailProps) {
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="col-span-5 flex flex-col shadow-md z-10">
        ...
        <div className="bg-closetoblack text-pearlwhite shadow-lg p-4 flex justify-center">
            <div className="p-4 grid grid-cols-[2fr_1fr_1fr_1fr] gap-4 max-w-4xl w-full">
      ...
      <div className="col-span-1 overflow-y-auto p-4 text-pearlwhite bg-closetoblack">
